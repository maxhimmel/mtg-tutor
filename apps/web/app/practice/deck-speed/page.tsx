      ...
      <SignedOut>
        <section className="max-w-2xl py-6">
          ...
          <p className="mt-4 text-lg leading-relaxed text-base-content/70">
            One card, and whether the decks that played it were fast, grindy, or
            neither. Measured from how long the games actually ran — not from what
            anyone says the card is for.
          </p>
